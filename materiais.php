...
<head>
    ...
    <style>
        ...
        @font-face {
            font-family: 'Circe';
            src: url('fontes/Circe/Circe-Bold.otf') format('opentype');
        }
        ...
        .accordion{
            --bs-accordion-btn-focus-border-color: #f4f4f4;
            --bs-accordion-active-color: black;
            --bs-accordion-active-bg: #f4f4f4;
            --bs-accordion-btn-focus-box-shadow: #f4f4f4;
        }
        .nav{
...
<body>
    ...
    <header class="mb-5">
        <div style="background-color: #fff;"><br><p class="text-center">NAVBAR</p><br></div>
    </header>
